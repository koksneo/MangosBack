DELETE FROM script_texts WHERE entry BETWEEN -1998999 AND -1998993;
INSERT INTO script_texts (`entry`,`content_default`,`type`,`comment`) VALUES
(-1998999,'Help! Please, You must help me!',0,'Galen - periodic say'),
(-1998998,'Let us leave this place.',0,'Galen - quest accepted'),
(-1998997,'Look out! The $c attacks!',0,'Galen - aggro 1'),
(-1998996,'Help! I\'m under attack!',0,'Galen - aggro 2'),
(-1998995,'Thank you $N. I will remember you always. You can find my strongbox in my camp, north of Stonard.',0,'Galen - quest complete'),
(-1998994,'%s whispers to $N the secret to opening his strongbox.',2,'Galen - emote whisper'),
(-1998993,'%s disappears into the swamp.',2,'Galen - emote disapper');
