...
<head>
<title>SourceForge.net Repository - [scriptdev2] Log of /sql/Updates/r1851_mangos.sql</title>
...
| <a href="/viewvc/scriptdev2/sql/Updates/r1851_mangos.sql?view=log"><img src="/viewvc-static/images/log.png" width="16" height="16" alt="Revision Log" /> Revision Log</a>
...
(<a href="/viewvc/scriptdev2/sql/Updates/r1851_mangos.sql?revision=1913&amp;view=markup">view</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1851_mangos.sql?revision=1913">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1851_mangos.sql?revision=1913&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1851_mangos.sql?annotate=1913">annotate</a>)
...
<input type="hidden" name="orig_pathtype" value="FILE"/><input type="hidden" name="orig_view" value="log"/><input type="hidden" name="orig_path" value="sql/Updates/r1851_mangos.sql"/><input type="hidden" name="view" value="redirect_pathrev"/>
...
Revision <a href="/viewvc/scriptdev2?view=revision&amp;revision=1852"><strong>1852</strong></a> -


(<a href="/viewvc/scriptdev2/sql/Updates/r1851_mangos.sql?revision=1852&amp;view=markup">view</a>)


(<a href="/viewvc/scriptdev2/sql/Updates/r1851_mangos.sql?revision=1852">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1851_mangos.sql?revision=1852&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1851_mangos.sql?annotate=1852">annotate</a>)



- <a href="/viewvc/scriptdev2/sql/Updates/r1851_mangos.sql?r1=1852&amp;view=log">[select for diffs]</a>
...
<em>Wed Nov  3 10:05:57 2010 UTC</em>
(6 weeks, 3 days ago)
by <em>nofantasy</em>
...
<br />File length: 82 byte(s)


<br />Copied from: <a href="/viewvc/scriptdev2/sql/Updates/1851_mangos.sql?view=log&amp;pathrev=1851"><em>sql/Updates/1851_mangos.sql</em></a> revision 1851
...
<pre class="vc_log">Add misc emote texts, provided by Forusim and Schmoozerd

In addition make common used boss emote text and use it in misc scripts.</pre>
</div>
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1851_mangos.sql" id="diff_select">
...
<input type="text" size="12" name="r2" value="1852" />
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1851_mangos.sql">
<div>
<hr />
<a name="logsort"></a>
