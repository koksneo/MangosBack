...
<head>
<title>SourceForge.net Repository - [scriptdev2] Log of /sql/Updates/r1899_scriptdev2.sql</title>
...
| <a href="/viewvc/scriptdev2/sql/Updates/r1899_scriptdev2.sql?view=log"><img src="/viewvc-static/images/log.png" width="16" height="16" alt="Revision Log" /> Revision Log</a>
...
(<a href="/viewvc/scriptdev2/sql/Updates/r1899_scriptdev2.sql?revision=1913&amp;view=markup">view</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1899_scriptdev2.sql?revision=1913">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1899_scriptdev2.sql?revision=1913&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1899_scriptdev2.sql?annotate=1913">annotate</a>)
...
<input type="hidden" name="orig_pathtype" value="FILE"/><input type="hidden" name="orig_view" value="log"/><input type="hidden" name="orig_path" value="sql/Updates/r1899_scriptdev2.sql"/><input type="hidden" name="view" value="redirect_pathrev"/>
...
Revision <a href="/viewvc/scriptdev2?view=revision&amp;revision=1899"><strong>1899</strong></a> -


(<a href="/viewvc/scriptdev2/sql/Updates/r1899_scriptdev2.sql?revision=1899&amp;view=markup">view</a>)


(<a href="/viewvc/scriptdev2/sql/Updates/r1899_scriptdev2.sql?revision=1899">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1899_scriptdev2.sql?revision=1899&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1899_scriptdev2.sql?annotate=1899">annotate</a>)



- <a href="/viewvc/scriptdev2/sql/Updates/r1899_scriptdev2.sql?r1=1899&amp;view=log">[select for diffs]</a>
...
<em>Wed Dec  8 08:59:54 2010 UTC</em>
...
<pre class="vc_log">Add support for quest 11332

Gossip texts unknown, info will be appreciated :)</pre>
</div>
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1899_scriptdev2.sql" id="diff_select">
...
<input type="text" size="12" name="r2" value="1899" />
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1899_scriptdev2.sql">
<div>
<hr />
<a name="logsort"></a>
