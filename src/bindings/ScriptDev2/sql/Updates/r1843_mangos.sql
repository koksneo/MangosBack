...
<head>
<title>SourceForge.net Repository - [scriptdev2] Log of /sql/Updates/r1843_mangos.sql</title>
...
| <a href="/viewvc/scriptdev2/sql/Updates/r1843_mangos.sql?view=log"><img src="/viewvc-static/images/log.png" width="16" height="16" alt="Revision Log" /> Revision Log</a>
...
(<a href="/viewvc/scriptdev2/sql/Updates/r1843_mangos.sql?revision=1913&amp;view=markup">view</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1843_mangos.sql?revision=1913">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1843_mangos.sql?revision=1913&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1843_mangos.sql?annotate=1913">annotate</a>)
...
<input type="hidden" name="orig_pathtype" value="FILE"/><input type="hidden" name="orig_view" value="log"/><input type="hidden" name="orig_path" value="sql/Updates/r1843_mangos.sql"/><input type="hidden" name="view" value="redirect_pathrev"/>
...
(<a href="/viewvc/scriptdev2/sql/Updates/r1843_mangos.sql?revision=1843&amp;view=markup">view</a>)


(<a href="/viewvc/scriptdev2/sql/Updates/r1843_mangos.sql?revision=1843">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1843_mangos.sql?revision=1843&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1843_mangos.sql?annotate=1843">annotate</a>)



- <a href="/viewvc/scriptdev2/sql/Updates/r1843_mangos.sql?r1=1843&amp;view=log">[select for diffs]</a>
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1843_mangos.sql" id="diff_select">
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1843_mangos.sql">
<div>
<hr />
<a name="logsort"></a>
