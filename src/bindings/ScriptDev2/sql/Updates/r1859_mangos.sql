...
<head>
<title>SourceForge.net Repository - [scriptdev2] Log of /sql/Updates/r1859_mangos.sql</title>
...
| <a href="/viewvc/scriptdev2/sql/Updates/r1859_mangos.sql?view=log"><img src="/viewvc-static/images/log.png" width="16" height="16" alt="Revision Log" /> Revision Log</a>
...
(<a href="/viewvc/scriptdev2/sql/Updates/r1859_mangos.sql?revision=1913&amp;view=markup">view</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1859_mangos.sql?revision=1913">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1859_mangos.sql?revision=1913&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1859_mangos.sql?annotate=1913">annotate</a>)
...
<input type="hidden" name="orig_pathtype" value="FILE"/><input type="hidden" name="orig_view" value="log"/><input type="hidden" name="orig_path" value="sql/Updates/r1859_mangos.sql"/><input type="hidden" name="view" value="redirect_pathrev"/>
...
Revision <a href="/viewvc/scriptdev2?view=revision&amp;revision=1859"><strong>1859</strong></a> -


(<a href="/viewvc/scriptdev2/sql/Updates/r1859_mangos.sql?revision=1859&amp;view=markup">view</a>)


(<a href="/viewvc/scriptdev2/sql/Updates/r1859_mangos.sql?revision=1859">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1859_mangos.sql?revision=1859&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1859_mangos.sql?annotate=1859">annotate</a>)



- <a href="/viewvc/scriptdev2/sql/Updates/r1859_mangos.sql?r1=1859&amp;view=log">[select for diffs]</a>
...
<em>Thu Nov  4 08:25:30 2010 UTC</em>
(6 weeks, 2 days ago)
by <em>nofantasy</em>
...
<pre class="vc_log">Add instance script for pit_of_saron. Patch by Schmoozerd, inspired by original of cristinel</pre>
</div>
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1859_mangos.sql" id="diff_select">
...
<input type="text" size="12" name="r2" value="1859" />
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1859_mangos.sql">
<div>
<hr />
<a name="logsort"></a>
