...
<head>
<title>SourceForge.net Repository - [scriptdev2] Log of /sql/Updates/r1863_mangos.sql</title>
...
| <a href="/viewvc/scriptdev2/sql/Updates/r1863_mangos.sql?view=log"><img src="/viewvc-static/images/log.png" width="16" height="16" alt="Revision Log" /> Revision Log</a>
...
(<a href="/viewvc/scriptdev2/sql/Updates/r1863_mangos.sql?revision=1913&amp;view=markup">view</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1863_mangos.sql?revision=1913">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1863_mangos.sql?revision=1913&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1863_mangos.sql?annotate=1913">annotate</a>)
...
<input type="hidden" name="orig_pathtype" value="FILE"/><input type="hidden" name="orig_view" value="log"/><input type="hidden" name="orig_path" value="sql/Updates/r1863_mangos.sql"/><input type="hidden" name="view" value="redirect_pathrev"/>
...
Revision <a href="/viewvc/scriptdev2?view=revision&amp;revision=1863"><strong>1863</strong></a> -


(<a href="/viewvc/scriptdev2/sql/Updates/r1863_mangos.sql?revision=1863&amp;view=markup">view</a>)


(<a href="/viewvc/scriptdev2/sql/Updates/r1863_mangos.sql?revision=1863">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1863_mangos.sql?revision=1863&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1863_mangos.sql?annotate=1863">annotate</a>)



- <a href="/viewvc/scriptdev2/sql/Updates/r1863_mangos.sql?r1=1863&amp;view=log">[select for diffs]</a>
...
<em>Sun Nov  7 11:46:17 2010 UTC</em>
(5 weeks, 6 days ago)
by <em>nofantasy</em>
...
<pre class="vc_log">Add script for areatrigger 5030 (rel. to quest 12575)</pre>
</div>
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1863_mangos.sql" id="diff_select">
...
<input type="text" size="12" name="r2" value="1863" />
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1863_mangos.sql">
<div>
<hr />
<a name="logsort"></a>
