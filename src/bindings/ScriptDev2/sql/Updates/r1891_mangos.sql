...
<head>
<title>SourceForge.net Repository - [scriptdev2] Log of /sql/Updates/r1891_mangos.sql</title>
...
| <a href="/viewvc/scriptdev2/sql/Updates/r1891_mangos.sql?view=log"><img src="/viewvc-static/images/log.png" width="16" height="16" alt="Revision Log" /> Revision Log</a>
...
(<a href="/viewvc/scriptdev2/sql/Updates/r1891_mangos.sql?revision=1913&amp;view=markup">view</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1891_mangos.sql?revision=1913">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1891_mangos.sql?revision=1913&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1891_mangos.sql?annotate=1913">annotate</a>)
...
<input type="hidden" name="orig_pathtype" value="FILE"/><input type="hidden" name="orig_view" value="log"/><input type="hidden" name="orig_path" value="sql/Updates/r1891_mangos.sql"/><input type="hidden" name="view" value="redirect_pathrev"/>
...
Revision <a href="/viewvc/scriptdev2?view=revision&amp;revision=1891"><strong>1891</strong></a> -


(<a href="/viewvc/scriptdev2/sql/Updates/r1891_mangos.sql?revision=1891&amp;view=markup">view</a>)


(<a href="/viewvc/scriptdev2/sql/Updates/r1891_mangos.sql?revision=1891">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1891_mangos.sql?revision=1891&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1891_mangos.sql?annotate=1891">annotate</a>)



- <a href="/viewvc/scriptdev2/sql/Updates/r1891_mangos.sql?r1=1891&amp;view=log">[select for diffs]</a>
...
<em>Thu Nov 25 10:19:44 2010 UTC</em>
(3 weeks, 2 days ago)
by <em>nofantasy</em>
...
<pre class="vc_log">Add dummy aura effect of 36035 (incl dummy of 36025,36115,36170,36181) and related events.
All related to quests 10458, 10480 and 10481.</pre>
</div>
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1891_mangos.sql" id="diff_select">
...
<input type="text" size="12" name="r2" value="1891" />
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1891_mangos.sql">
<div>
<hr />
<a name="logsort"></a>
