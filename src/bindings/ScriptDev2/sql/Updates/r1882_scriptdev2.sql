...
<head>
<title>SourceForge.net Repository - [scriptdev2] Log of /sql/Updates/r1882_scriptdev2.sql</title>
...
| <a href="/viewvc/scriptdev2/sql/Updates/r1882_scriptdev2.sql?view=log"><img src="/viewvc-static/images/log.png" width="16" height="16" alt="Revision Log" /> Revision Log</a>
...
(<a href="/viewvc/scriptdev2/sql/Updates/r1882_scriptdev2.sql?revision=1913&amp;view=markup">view</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1882_scriptdev2.sql?revision=1913">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1882_scriptdev2.sql?revision=1913&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1882_scriptdev2.sql?annotate=1913">annotate</a>)
...
<input type="hidden" name="orig_pathtype" value="FILE"/><input type="hidden" name="orig_view" value="log"/><input type="hidden" name="orig_path" value="sql/Updates/r1882_scriptdev2.sql"/><input type="hidden" name="view" value="redirect_pathrev"/>
...
Revision <a href="/viewvc/scriptdev2?view=revision&amp;revision=1883"><strong>1883</strong></a> -


(<a href="/viewvc/scriptdev2/sql/Updates/r1882_scriptdev2.sql?revision=1883&amp;view=markup">view</a>)


(<a href="/viewvc/scriptdev2/sql/Updates/r1882_scriptdev2.sql?revision=1883">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1882_scriptdev2.sql?revision=1883&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1882_scriptdev2.sql?annotate=1883">annotate</a>)



- <a href="/viewvc/scriptdev2/sql/Updates/r1882_scriptdev2.sql?r1=1883&amp;view=log">[select for diffs]</a>
...
<em>Wed Nov 17 15:38:41 2010 UTC</em>
(4 weeks, 3 days ago)
by <em>nofantasy</em>
...
<br />File length: 207 byte(s)


<br />Copied from: <a href="/viewvc/scriptdev2/sql/Updates/r1882_scriptdev.sql?view=log&amp;pathrev=1882"><em>sql/Updates/r1882_scriptdev.sql</em></a> revision 1882
...
<pre class="vc_log">Fix file name</pre>
</div>
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1882_scriptdev2.sql" id="diff_select">
...
<input type="text" size="12" name="r2" value="1883" />
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1882_scriptdev2.sql">
<div>
<hr />
<a name="logsort"></a>
