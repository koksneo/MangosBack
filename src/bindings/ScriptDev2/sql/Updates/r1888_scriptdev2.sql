...
<head>
<title>SourceForge.net Repository - [scriptdev2] Log of /sql/Updates/r1888_scriptdev2.sql</title>
...
| <a href="/viewvc/scriptdev2/sql/Updates/r1888_scriptdev2.sql?view=log"><img src="/viewvc-static/images/log.png" width="16" height="16" alt="Revision Log" /> Revision Log</a>
...
(<a href="/viewvc/scriptdev2/sql/Updates/r1888_scriptdev2.sql?revision=1913&amp;view=markup">view</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1888_scriptdev2.sql?revision=1913">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1888_scriptdev2.sql?revision=1913&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1888_scriptdev2.sql?annotate=1913">annotate</a>)
...
<input type="hidden" name="orig_pathtype" value="FILE"/><input type="hidden" name="orig_view" value="log"/><input type="hidden" name="orig_path" value="sql/Updates/r1888_scriptdev2.sql"/><input type="hidden" name="view" value="redirect_pathrev"/>
...
Revision <a href="/viewvc/scriptdev2?view=revision&amp;revision=1888"><strong>1888</strong></a> -


(<a href="/viewvc/scriptdev2/sql/Updates/r1888_scriptdev2.sql?revision=1888&amp;view=markup">view</a>)


(<a href="/viewvc/scriptdev2/sql/Updates/r1888_scriptdev2.sql?revision=1888">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1888_scriptdev2.sql?revision=1888&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1888_scriptdev2.sql?annotate=1888">annotate</a>)



- <a href="/viewvc/scriptdev2/sql/Updates/r1888_scriptdev2.sql?r1=1888&amp;view=log">[select for diffs]</a>
...
<em>Tue Nov 23 13:37:57 2010 UTC</em>
(3 weeks, 4 days ago)
by <em>nofantasy</em>
...
<pre class="vc_log">Making one quest become not so bloody imp-ossible, using new AI call OwnerKilledUnit</pre>
</div>
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1888_scriptdev2.sql" id="diff_select">
...
<input type="text" size="12" name="r2" value="1888" />
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1888_scriptdev2.sql">
<div>
<hr />
<a name="logsort"></a>
