...
<head>
<title>SourceForge.net Repository - [scriptdev2] Log of /sql/Updates/r1871_mangos.sql</title>
...
| <a href="/viewvc/scriptdev2/sql/Updates/r1871_mangos.sql?view=log"><img src="/viewvc-static/images/log.png" width="16" height="16" alt="Revision Log" /> Revision Log</a>
...
(<a href="/viewvc/scriptdev2/sql/Updates/r1871_mangos.sql?revision=1913&amp;view=markup">view</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1871_mangos.sql?revision=1913">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1871_mangos.sql?revision=1913&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1871_mangos.sql?annotate=1913">annotate</a>)
...
<input type="hidden" name="orig_pathtype" value="FILE"/><input type="hidden" name="orig_view" value="log"/><input type="hidden" name="orig_path" value="sql/Updates/r1871_mangos.sql"/><input type="hidden" name="view" value="redirect_pathrev"/>
...
Revision <a href="/viewvc/scriptdev2?view=revision&amp;revision=1871"><strong>1871</strong></a> -


(<a href="/viewvc/scriptdev2/sql/Updates/r1871_mangos.sql?revision=1871&amp;view=markup">view</a>)


(<a href="/viewvc/scriptdev2/sql/Updates/r1871_mangos.sql?revision=1871">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1871_mangos.sql?revision=1871&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1871_mangos.sql?annotate=1871">annotate</a>)



- <a href="/viewvc/scriptdev2/sql/Updates/r1871_mangos.sql?r1=1871&amp;view=log">[select for diffs]</a>
...
<em>Sat Nov 13 23:41:45 2010 UTC</em>
(4 weeks, 6 days ago)
by <em>nofantasy</em>
...
<pre class="vc_log">Add dummy effect of spell 39246. Patch by virusav (based on original from Kirix)</pre>
</div>
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1871_mangos.sql" id="diff_select">
...
<input type="text" size="12" name="r2" value="1871" />
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1871_mangos.sql">
<div>
<hr />
<a name="logsort"></a>
