        ...
        switch(pCreature->GetEntry())
        {
            ...
            case NPC_RAGNAROS:
                ...
                if (m_auiEncounter[8] == DONE)
                {
                    ...
                    if (Creature *pDomo = pCreature->SummonCreature(NPC_DOMO, (float)SPAWN_RAG_X, (float)SPAWN_RAG_Y, (float)SPAWN_RAG_Z, (float)SPAWN_RAG_O, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 180000) )
        ...
        switch(uiType)
        {
            ...
            case TYPE_MAJORDOMO:
                ...
                if (uiData == DONE)
                {
                    ...
                    {
                        if (Creature *pDomo = pRagnaros->SummonCreature(NPC_DOMO, (float)SPAWN_RAG_X, (float)SPAWN_RAG_Y, (float)SPAWN_RAG_Z, (float)SPAWN_RAG_O, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 180000) )
                            pDomo->SetUInt32Value(UNIT_NPC_FLAGS, 1);
                    }
                }
                break;
