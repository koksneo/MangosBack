...
<head>
<title>SourceForge.net Repository - [scriptdev2] Log of /sql/Updates/r1878_mangos.sql</title>
...
| <a href="/viewvc/scriptdev2/sql/Updates/r1878_mangos.sql?view=log"><img src="/viewvc-static/images/log.png" width="16" height="16" alt="Revision Log" /> Revision Log</a>
...
(<a href="/viewvc/scriptdev2/sql/Updates/r1878_mangos.sql?revision=1913&amp;view=markup">view</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1878_mangos.sql?revision=1913">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1878_mangos.sql?revision=1913&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1878_mangos.sql?annotate=1913">annotate</a>)
...
<input type="hidden" name="orig_pathtype" value="FILE"/><input type="hidden" name="orig_view" value="log"/><input type="hidden" name="orig_path" value="sql/Updates/r1878_mangos.sql"/><input type="hidden" name="view" value="redirect_pathrev"/>
...
Revision <a href="/viewvc/scriptdev2?view=revision&amp;revision=1878"><strong>1878</strong></a> -


(<a href="/viewvc/scriptdev2/sql/Updates/r1878_mangos.sql?revision=1878&amp;view=markup">view</a>)


(<a href="/viewvc/scriptdev2/sql/Updates/r1878_mangos.sql?revision=1878">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1878_mangos.sql?revision=1878&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1878_mangos.sql?annotate=1878">annotate</a>)



- <a href="/viewvc/scriptdev2/sql/Updates/r1878_mangos.sql?r1=1878&amp;view=log">[select for diffs]</a>
...
<em>Tue Nov 16 12:30:27 2010 UTC</em>
(4 weeks, 4 days ago)
by <em>nofantasy</em>
...
<pre class="vc_log">Add dummy effect of spell 52741 (related to quest 12813).

Note it may not be fully correct, expecting visual effects.</pre>
</div>
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1878_mangos.sql" id="diff_select">
...
<input type="text" size="12" name="r2" value="1878" />
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1878_mangos.sql">
<div>
<hr />
<a name="logsort"></a>
