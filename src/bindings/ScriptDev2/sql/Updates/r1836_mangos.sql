...
<head>
<title>SourceForge.net Repository - [scriptdev2] Log of /sql/Updates/r1836_mangos.sql</title>
...
| <a href="/viewvc/scriptdev2/sql/Updates/r1836_mangos.sql?view=log"><img src="/viewvc-static/images/log.png" width="16" height="16" alt="Revision Log" /> Revision Log</a>
...
(<a href="/viewvc/scriptdev2/sql/Updates/r1836_mangos.sql?revision=1913&amp;view=markup">view</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1836_mangos.sql?revision=1913">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1836_mangos.sql?revision=1913&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1836_mangos.sql?annotate=1913">annotate</a>)
...
<input type="hidden" name="orig_pathtype" value="FILE"/><input type="hidden" name="orig_view" value="log"/><input type="hidden" name="orig_path" value="sql/Updates/r1836_mangos.sql"/><input type="hidden" name="view" value="redirect_pathrev"/>
...
Revision <a href="/viewvc/scriptdev2?view=revision&amp;revision=1836"><strong>1836</strong></a> -


(<a href="/viewvc/scriptdev2/sql/Updates/r1836_mangos.sql?revision=1836&amp;view=markup">view</a>)


(<a href="/viewvc/scriptdev2/sql/Updates/r1836_mangos.sql?revision=1836">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1836_mangos.sql?revision=1836&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1836_mangos.sql?annotate=1836">annotate</a>)



- <a href="/viewvc/scriptdev2/sql/Updates/r1836_mangos.sql?r1=1836&amp;view=log">[select for diffs]</a>
...
<em>Wed Oct  6 15:09:32 2010 UTC</em>
(2 months, 1 week ago)
by <em>deverend</em>
...
<pre class="vc_log">Added support for quest 11209. Original patch by Goaul.
</pre>
</div>
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1836_mangos.sql" id="diff_select">
...
<input type="text" size="12" name="r2" value="1836" />
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1836_mangos.sql">
<div>
<hr />
<a name="logsort"></a>
