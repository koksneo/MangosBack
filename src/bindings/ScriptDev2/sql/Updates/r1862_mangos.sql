...
<head>
<title>SourceForge.net Repository - [scriptdev2] Log of /sql/Updates/r1862_mangos.sql</title>
...
| <a href="/viewvc/scriptdev2/sql/Updates/r1862_mangos.sql?view=log"><img src="/viewvc-static/images/log.png" width="16" height="16" alt="Revision Log" /> Revision Log</a>
...
(<a href="/viewvc/scriptdev2/sql/Updates/r1862_mangos.sql?revision=1913&amp;view=markup">view</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1862_mangos.sql?revision=1913">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1862_mangos.sql?revision=1913&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1862_mangos.sql?annotate=1913">annotate</a>)
...
<input type="hidden" name="orig_pathtype" value="FILE"/><input type="hidden" name="orig_view" value="log"/><input type="hidden" name="orig_path" value="sql/Updates/r1862_mangos.sql"/><input type="hidden" name="view" value="redirect_pathrev"/>
...
Revision <a href="/viewvc/scriptdev2?view=revision&amp;revision=1862"><strong>1862</strong></a> -


(<a href="/viewvc/scriptdev2/sql/Updates/r1862_mangos.sql?revision=1862&amp;view=markup">view</a>)


(<a href="/viewvc/scriptdev2/sql/Updates/r1862_mangos.sql?revision=1862">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1862_mangos.sql?revision=1862&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1862_mangos.sql?annotate=1862">annotate</a>)



- <a href="/viewvc/scriptdev2/sql/Updates/r1862_mangos.sql?r1=1862&amp;view=log">[select for diffs]</a>
...
<em>Fri Nov  5 19:34:35 2010 UTC</em>
(6 weeks, 1 day ago)
by <em>nofantasy</em>
...
<pre class="vc_log">Add basic support for quest 11300 (still need additional ACID support for end miniboss -&gt; spell 43326)</pre>
</div>
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1862_mangos.sql" id="diff_select">
...
<input type="text" size="12" name="r2" value="1862" />
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1862_mangos.sql">
<div>
<hr />
<a name="logsort"></a>
