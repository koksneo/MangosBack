...
<head>
<title>SourceForge.net Repository - [scriptdev2] Log of /sql/Updates/r1881_mangos.sql</title>
...
| <a href="/viewvc/scriptdev2/sql/Updates/r1881_mangos.sql?view=log"><img src="/viewvc-static/images/log.png" width="16" height="16" alt="Revision Log" /> Revision Log</a>
...
(<a href="/viewvc/scriptdev2/sql/Updates/r1881_mangos.sql?revision=1913&amp;view=markup">view</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1881_mangos.sql?revision=1913">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1881_mangos.sql?revision=1913&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1881_mangos.sql?annotate=1913">annotate</a>)
...
<input type="hidden" name="orig_pathtype" value="FILE"/><input type="hidden" name="orig_view" value="log"/><input type="hidden" name="orig_path" value="sql/Updates/r1881_mangos.sql"/><input type="hidden" name="view" value="redirect_pathrev"/>
...
Revision <a href="/viewvc/scriptdev2?view=revision&amp;revision=1881"><strong>1881</strong></a> -


(<a href="/viewvc/scriptdev2/sql/Updates/r1881_mangos.sql?revision=1881&amp;view=markup">view</a>)


(<a href="/viewvc/scriptdev2/sql/Updates/r1881_mangos.sql?revision=1881">download</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1881_mangos.sql?revision=1881&amp;content-type=text%2Fplain">as text</a>)
(<a href="/viewvc/scriptdev2/sql/Updates/r1881_mangos.sql?annotate=1881">annotate</a>)



- <a href="/viewvc/scriptdev2/sql/Updates/r1881_mangos.sql?r1=1881&amp;view=log">[select for diffs]</a>
...
<em>Wed Nov 17 09:03:11 2010 UTC</em>
(4 weeks, 3 days ago)
by <em>nofantasy</em>
...
<pre class="vc_log">Add support for fishing up boss in SSC (w/some boss abilities based on ACID). Patch by Schmoozerd</pre>
</div>
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1881_mangos.sql" id="diff_select">
...
<input type="text" size="12" name="r2" value="1881" />
...
<form method="get" action="/viewvc/scriptdev2/sql/Updates/r1881_mangos.sql">
<div>
<hr />
<a name="logsort"></a>
