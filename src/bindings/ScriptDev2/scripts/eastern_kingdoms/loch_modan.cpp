    ...
    void WaypointReached(uint32 uiPointId)
    {
        switch (uiPointId)
        {
            case 19:
                ...
                m_creature->SummonCreature(NPC_DARK_IRON_DWARF, m_afAmbushSpawn[0].m_fX, m_afAmbushSpawn[0].m_fY, m_afAmbushSpawn[0].m_fZ, m_afAmbushSpawn[0].m_fO, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 300000);
                m_creature->SummonCreature(NPC_DARK_IRON_DWARF, m_afAmbushSpawn[1].m_fX, m_afAmbushSpawn[1].m_fY, m_afAmbushSpawn[1].m_fZ, m_afAmbushSpawn[1].m_fO, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 300000);
                break;
            case 23:
