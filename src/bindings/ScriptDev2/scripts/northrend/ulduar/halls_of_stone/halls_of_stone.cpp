    ...
    void UpdateEscortAI(const uint32 uiDiff)
    {
        if (m_uiPhase_timer < uiDiff)
        {
            switch(m_uiStep)
            {
                ...
                case 5:
                    if (m_pInstance)
                        if (Creature* pTemp = ((Creature*)m_creature->GetMap()->GetUnit(m_pInstance->GetData64(DATA_ABEDNEUM))))
                ...
                case 7:
                    if (m_pInstance)
                        if (Creature* pTemp = ((Creature*)m_creature->GetMap()->GetUnit(m_pInstance->GetData64(DATA_KADDRAK))))
                ...
                case 8:
                    ...
                    if (Creature* pTemp = m_pInstance->instance->GetCreature(m_uiControllerGUID))
                ...
                case 11:
                    if (m_pInstance)
                        if (Creature* pTemp = ((Creature*)m_creature->GetMap()->GetUnit(m_pInstance->GetData64(DATA_MARNAK))))
